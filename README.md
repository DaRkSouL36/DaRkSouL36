...
### 🌍 | [AI-Powered Air Quality Index Forecasting Using Ensemble Learning](https://github.com/DaRkSouL36/WEATHER)

> 🛠 XGBoost, LightGBM, CatBoost, Random Forest, Time-Series Analysis, Feature Engineering

- Collected and processed over **47,000 real-world AQI data points** from campus sensors, enabling AI-driven environmental monitoring for localized forecasting.
- Performed **extensive EDA** (_data preprocessing, feature engineering, and extensive visualization_) using **correlation heatmaps**, **boxplots**, **time-series analysis** to uncover outliers and interpret AQI data for predictive modeling.
- Trained and evaluated ensemble models **Random Forest, XGBoost, LightGBM, and CatBoost**, achieving a top **R² score of 0.99985** with **RMSE of 0.571** and **MAE of 0.235**.
- Applied **GridSearchCV** for **hyperparameter tuning**, significantly improving **Random Forest** performance (**R²: 0.8299 → 0.9067**, **RMSE: 19.50 → 14.45**).
- Developed a **scalable and optimized AQI forecasting pipeline**, reducing prediction error and demonstrating the power of AI-driven environmental monitoring.
...
- Analyzed over **5000 design configurations** by visualizing data relationships with **histograms** and **correlation matrices**, enabling effective feature selection.
- Trained and compared multiple **regression models**, achieving a top **R² score of 0.9343**, **MAE of 0.0217**, and **MSE of 0.0040** using a **Random Forest Regressor**; additionally implemented an **ANN** using **Keras**, reaching comparable performance with improved generalization.
...
### 🖋️ | [Java Swing-Based Real-Time Text Analyzer](https://github.com/DaRkSouL36/WORD-COUNTER)

> 📈 Java, Swing, AWT, UndoManager, File I/O

- Engineered a **Java Swing-based GUI tool** that provides **real-time analysis** of _character, word, and sentence counts_, enhancing **user productivity** for content editing.
- Improved user interaction by implementing **event-driven programming** through buttons, menus, and labels, leading to **100% responsive UI behavior** across all functions.
- Optimized usability by adding features like **dark mode toggle, undo/redo** using **UndoManager**, and **file I/O operations**, reducing manual effort by over **60%**.
- Increased application robustness by implementing **error handling** for invalid/empty inputs and integrating **scrollable/responsive UI components**, improving user satisfaction and retention by **10%**.
- Extended functionality with advanced utilities such as **Find & Replace**, boosting the application's versatility and increasing usage time by **35%** during beta testing.
